...
class GuardMap {
    ...
    getAmountOfVisitedPlaces() {
        let amountOfVisitedPlaces = 0;
        let shouldKeepWalking = true;
        while (shouldKeepWalking) {
...
(async function main() {
    ...
    const guardMap = new GuardMap(map, startPosition);
    console.log(guardMap.getAmountOfVisitedPlaces());
})();